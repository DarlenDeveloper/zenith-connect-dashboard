...
const AgentSelector = ({ onAgentSelected }: AgentSelectorProps) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Card className="max-w-md w-full mx-auto shadow-xl border-none">
        <CardHeader className="text-center pb-2">
          <CardTitle className="text-2xl">Select an Agent</CardTitle>
          <p className="text-gray-500 mt-1">
            You must select and authenticate as an agent to continue
          </p>
        </CardHeader>
        <CardContent>
          {loadingAgents ? (
